...
public final class PrestoThriftExpression
{
    ...
    public static PrestoThriftExpression fromSpiExpression(SpiExpression expression)
    {
        if (expression.getClass() == SpiUnaryExpression.class) {
            return new PrestoThriftExpression(PrestoThriftUnaryExpression.fromSpiUnaryExpression((SpiUnaryExpression) expression));
        }
        else {
