...
public final class PrestoThriftRangeValueSet
{
    ...
    public static SortedRangeSet toSortedRangeSet(PrestoThriftRangeValueSet valueSet)
    {
        List<Range> ranges = valueSet.getRanges().stream()
                .map(PrestoThriftRange::toRange)
                .collect(toImmutableList());
        // TODO Type
        return SortedRangeSet.copyOf(BooleanType.BOOLEAN, ranges);
    }
    ...
    public static final class PrestoThriftMarker
    {
        ...
        public static Marker toMarker(PrestoThriftMarker marker)
        {
            Optional<Block> value = (marker.getValue() != null) ? Optional.of(marker.getValue().toBlock(marker.getValue().inferType())) : Optional.empty();
            // TODO Type
            return new Marker(BooleanType.BOOLEAN, value, PrestoThriftBound.toBound(marker.getBound()));
        }
    }
    ...
    public static final class PrestoThriftRange
    {
        ...
        public static Range toRange(PrestoThriftRange range)
        {
            return new Range(PrestoThriftMarker.toMarker(range.getLow()), PrestoThriftMarker.toMarker(range.getHigh()));
        }
    }
}
